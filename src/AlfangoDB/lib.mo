...
module {
    ...
    public type ScanWithSearchAndSortInputType = InputTypes.ScanWithSearchAndSortInputType;
    ...
    public type ItemOutputType = OutputTypes.ItemOutputType;

    public let {
        scan;
        scanAndGetIds;
        paginatedScan;
        scanUsingGlobalSearchAndSort;
        scanAndGetIdsUsingGlobalSearchAndSort;
        applyPagination;
        sortArrayItems;
        sortArrayItemsWithMultipleKeys;
    } = Search;
